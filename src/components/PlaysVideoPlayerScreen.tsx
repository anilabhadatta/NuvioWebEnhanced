...
const PlaysVideoWrapper = React.memo(({ resolvedSrc, onInit }: { resolvedSrc: string, onInit: (v: HTMLVideoElement, e: PlaysVideoEngine) => void }) => {
...
export default function PlaysVideoPlayerScreen() {
  ...
  }, [showEpisodesPanel, movieId, hasValidTmdbId, resolvedTmdbId, episodesSeasonNum]);
    ...
    >
      ...
      <style dangerouslySetInnerHTML={{
        ...
        video::cue {
          ...
          background-color: ${subtitleStyle.bgColor === 'transparent' ? 'transparent' : subtitleStyle.bgColor} !important;
          opacity: ${subtitleStyle.bgPct / 100} !important;
          ${subtitleStyle.edge === 'shadow' ? 'text-shadow: 2px 2px 4px rgba(0,0,0,0.8) !important;' : ''}
          ${subtitleStyle.edge === 'outline' ? 'text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000 !important;' : ''}
          ${subtitleStyle.edge === 'raised' ? 'text-shadow: 0 1px 0 #ccc, 0 2px 0 #c5c5c5, 0 3px 0 #bbb, 0 4px 0 #b9b9b9, 0 5px 0 #aaa, 0 6px 1px rgba(0,0,0,.1), 0 0 5px rgba(0,0,0,.1), 0 1px 3px rgba(0,0,0,.3), 0 3px 5px rgba(0,0,0,.2), 0 5px 10px rgba(0,0,0,.25), 0 10px 10px rgba(0,0,0,.2), 0 20px 20px rgba(0,0,0,.15) !important;' : ''}
        }
      ` }} />
